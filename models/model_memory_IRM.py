...
class model_memory_IRM(nn.Module):
    ...
    def forward(self, past, scene=None):
        ...
        #print('prova')
        #self.index_max = torch.sort(self.weight_read, descending=True)[1].cpu()[:, self.num_prediction:self.num_prediction*2]
    ...
    def write_in_memory(self, past, future, scene=None):
        ...
        #index_max = torch.topk(weight_read.squeeze(), self.num_prediction * 2)[1][:, 6:]
